...
const getRotation = (x1: number, x2: number, y1: number, y2: number) => 270 + 180 / Math.PI * Math.atan((y2 - y1) / (x2 - x1))
</script>
...
<template>
  ...
  <CalligraphyStrokeOne class="stick-torso" :x1="bodyX1" :y1="bodyY1" :length="bodyLength" stroke-width="2"
    stroke="black" />
  <!-- <line stroke-linejoin="round" class="stick-torso" :x1="bodyX1" :y1="bodyY1" :x2="bodyX2" :y2="bodyY2" stroke-width="2"
    stroke="black">
  </line> -->
  <CalligraphyStrokeOne class="stick-upper-arm-right"
    :rotation="getRotation(bodyX1, rightUpperArmX2, upperArmY1, rightUpperArmY2)" :x1="bodyX1" :y1="upperArmY1"
    :length="upperArmLength" stroke-width="2" stroke="black" />
  <CalligraphyStrokeOne class="stick-upper-arm-left"
    :rotation="180 + getRotation(bodyX1, leftUpperArmX2, upperArmY1, leftUpperArmY2)" :x1="bodyX1" :y1="upperArmY1"
    :length="upperArmLength" stroke-width="2" stroke="black" />
  ...
  <CalligraphyStrokeOne class="stick-lower-arm-right"
    :rotation="getRotation(rightUpperArmX2, rightLowerArmX2, rightUpperArmY2, rightLowerArmY2)" :x1="rightUpperArmX2"
    :y1="rightUpperArmY2" :length="lowerArmLength" stroke-width="2" stroke="black" />
  <CalligraphyStrokeOne class="stick-lower-arm-left"
    :rotation="180 + getRotation(leftUpperArmX2, leftLowerArmX2, leftUpperArmY2, leftLowerArmY2)" :x1="leftUpperArmX2"
    :y1="leftUpperArmY2" :length="lowerArmLength" stroke-width="2" stroke="black" />
  ...
  <CalligraphyStrokeOne class="stick-hand-right"
    :rotation="getRotation(rightLowerArmX2, rightHandX2, rightLowerArmY2, rightHandY2)" :x1="rightLowerArmX2"
    :y1="rightLowerArmY2" :length="handLength" stroke-width="2" stroke="black" />
  <CalligraphyStrokeOne class="stick-hand-left"
    :rotation="getRotation(leftLowerArmX2, leftHandX2, leftLowerArmY2, leftHandX2)" :x1="leftLowerArmX2"
    :y1="leftLowerArmY2" :length="handLength" stroke-width="2" stroke="black" />
  ...
  <CalligraphyStrokeOne class="stick-upper-leg-right"
    :rotation="getRotation(bodyX1, rightUpperLegX2, bodyY2, rightUpperLegY2)" :x1="bodyX1" :y1="bodyY2"
    :length="upperLegLength" stroke-width="2" stroke="black" />
  <CalligraphyStrokeOne class="stick-upper-leg-left"
    :rotation="180 + getRotation(bodyX1, leftUpperLegX2, bodyY2, leftUpperLegY2)" :x1="bodyX1" :y1="bodyY2"
    :length="upperLegLength" stroke-width="2" stroke="black" />
  ...
  <CalligraphyStrokeOne class="stick-lower-leg-right"
    :rotation="getRotation(rightUpperLegX2, rightLowerLegX2, rightUpperLegY2, rightLowerLegY2)" :x1="rightUpperLegX2"
    :y1="rightUpperLegY2" :length="lowerLegLength" stroke-width="2" stroke="black" />
  <CalligraphyStrokeOne class="stick-lower-leg-left"
    :rotation="180 + getRotation(leftUpperLegX2, leftLowerLegX2, leftUpperLegY2, leftLowerLegY2)" :x1="leftUpperLegX2"
    :y1="leftUpperLegY2" :length="lowerLegLength" stroke-width="2" stroke="black" />
</template>
